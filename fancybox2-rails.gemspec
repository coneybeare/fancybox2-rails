...
Gem::Specification.new do |s|
  ...
  s.summary     = "Use FancyBox 2 with Rails 3.1/4.0/5.x/6.x"
  s.description = "This gem provides jQuery FancyBox 2 for your Rails 3.1/4.0/6.x application. This gem is based on the gem for Fancybox 1.x by Chris Mytton"
  s.files       = Dir["{app,lib}/**/*"] + ["MIT-LICENSE", "Rakefile", "Gemfile", "README.md"]
  s.version     = Fancybox2::Rails::VERSION

  s.add_dependency "railties", ">= 3.1.0", "<= 6.1"
